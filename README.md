...
Главная: содержит информацию о выполненном проекте, доступна всем пользователям.<br/>
Страница с фильмами. На ней есть форма поиска фильмов и блок с результатами поиска, доступна только авторизированным пользователям.<br/>
Страница с сохранёнными фильмами. Показывает фильмы, сохранённые пользователем, доступна только после авторизации.<br/>
Страница регистрации. Позволяет пользователю зарегистрировать аккаунт, доступна всем пользователям.<br/>
Страница авторизации. На ней пользователь может войти в систему, доступна всем пользователям.<br/>
Страница редактирования профиля. Пользователь может изменить данные своего аккаунта, доступна только после авторизации.<br/>
