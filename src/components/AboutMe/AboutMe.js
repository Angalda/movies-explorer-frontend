    ...
    return (
        <div className="aboutMe__container">
            ...
            <ul className="aboutMe__portfolio">
                ...
                <li className="aboutMe__portfolio-item"><a href="#" className="aboutMe__portfolio-link">Адаптивный сайт</a><img src={icon}className="aboutMe__portfolio-icon"></img></li>
                <li className="aboutMe__portfolio-item"><a href="#" className="aboutMe__portfolio-link">Одностраничное приложение</a><img src={icon}className="aboutMe__portfolio-icon"></img></li>
            </ul>
